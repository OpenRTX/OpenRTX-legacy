...
#define GPIO_RotarySW_Line0 	GPIOE
#define Pin_RotarySW_Line0	    14
#define GPIO_RotarySW_Line1 	GPIOE
#define Pin_RotarySW_Line1 	    15
#define GPIO_RotarySW_Line2 	GPIOB
#define Pin_RotarySW_Line2 	    10
#define GPIO_RotarySW_Line3 	GPIOB
#define Pin_RotarySW_Line3 	    11
