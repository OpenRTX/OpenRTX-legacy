...
#if defined(PLATFORM_GD77S) || defined(PLATFORM_MD380)
...
void init_rotary_switch(void)
{
    ...
    gpio_setMode(GPIO_RotarySW_Line0, Pin_RotarySW_Line0, INPUT);
    gpio_setMode(GPIO_RotarySW_Line1, Pin_RotarySW_Line1, INPUT);
    gpio_setMode(GPIO_RotarySW_Line2, Pin_RotarySW_Line2, INPUT);
    gpio_setMode(GPIO_RotarySW_Line3, Pin_RotarySW_Line3, INPUT);
...
#elif defined(PLATFORM_MD380)
	static const uint8_t rsPositions[] = { 11, 14, 10, 15, 6, 3, 7, 2, 12, 13, 9, 16, 5, 4, 8, 1 };
    int pos = gpio_readPin(GPIO_RotarySW_Line0, Pin_RotarySW_Line0) |
              gpio_readPin(GPIO_RotarySW_Line1, Pin_RotarySW_Line1) << 1 |
              gpio_readPin(GPIO_RotarySW_Line2, Pin_RotarySW_Line2) << 2 |
              gpio_readPin(GPIO_RotarySW_Line3, Pin_RotarySW_Line3) << 3;
